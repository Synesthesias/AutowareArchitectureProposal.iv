...
void NormalDistributionsTransformOMP<PointSource, PointTarget>::setInputTarget(
  const std::shared_ptr<pcl::PointCloud<PointTarget>> & map_ptr)
{
...
void NormalDistributionsTransformOMP<PointSource, PointTarget>::setInputSource(
  const std::shared_ptr<pcl::PointCloud<PointSource>> & scan_ptr)
{
...
template<class PointSource, class PointTarget>
std::shared_ptr<const pcl::PointCloud<PointTarget>>
...
template<class PointSource, class PointTarget>
std::shared_ptr<const pcl::PointCloud<PointSource>>
...
template<class PointSource, class PointTarget>
std::shared_ptr<pcl::search::KdTree<PointTarget>>
