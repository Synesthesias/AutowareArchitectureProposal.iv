...
public:
  ...
  virtual void setInputTarget(const std::shared_ptr<pcl::PointCloud<PointTarget>> & map_ptr) = 0;
  virtual void setInputSource(const std::shared_ptr<pcl::PointCloud<PointSource>> & scan_ptr) = 0;
  ...
  virtual std::shared_ptr<const pcl::PointCloud<PointTarget>> getInputTarget() const = 0;
  virtual std::shared_ptr<const pcl::PointCloud<PointSource>> getInputSource() const = 0;
  ...
  virtual std::shared_ptr<pcl::search::KdTree<PointTarget>> getSearchMethodTarget() const = 0;
};
