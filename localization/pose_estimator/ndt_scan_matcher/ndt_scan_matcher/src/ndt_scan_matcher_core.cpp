  ...
  sensor_msgs::msg::PointCloud2::ConstSharedPtr map_points_msg_ptr)
{
  ...
  std::shared_ptr<pcl::PointCloud<PointTarget>> map_points_ptr(new pcl::PointCloud<PointTarget>);
  ...
  sensor_msgs::msg::PointCloud2::ConstSharedPtr sensor_points_sensorTF_msg_ptr)
{
  ...
  std::shared_ptr<pcl::PointCloud<PointSource>> sensor_points_sensorTF_ptr(
