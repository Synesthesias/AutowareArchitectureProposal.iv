...
template <class PointType>
void MatchingScore<PointType>::setInputTarget(const PointCloudConstPtr & pointcloud_ptr)
{
...
template <class PointType>
void MatchingScore<PointType>::setSearchMethodTarget(const KdTreePtr & tree_ptr)
{
  tree_ptr_ = tree_ptr;
}

template <class PointType>
double MatchingScore<PointType>::calcMatchingScore(const PointCloudConstPtr & pointcloud_ptr)
{
