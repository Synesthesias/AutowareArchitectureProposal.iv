...
public:
  ...
  void setInputTarget(const pcl::shared_ptr<const pcl::PointCloud<PointType>> & pointcloud_ptr);
  void setSearchMethodTarget(const pcl::shared_ptr<pcl::search::KdTree<PointType>> & tree_ptr);
  double calcMatchingScore(const pcl::shared_ptr<const pcl::PointCloud<PointType>> & pointcloud_ptr);
...
private:
  ...
  pcl::shared_ptr<pcl::search::KdTree<PointType>> tree_ptr_;
